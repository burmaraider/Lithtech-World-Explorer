...
namespace LTTypes
{
    public class LTTypes
    {
        ...
        public struct UnknownStruct
        {
            ...
            public LTVector v1 { get; set; }
            public LTVector v2 { get; set; }

        }

        public struct DiskVert
        {
            public ushort nVerts { get; set; }
            public byte nDummy1 { get; set; }
            public byte nDummy2 { get; set; }
            public byte nDummy3 { get; set; }

        }
        public struct NodeIndice
        {
            public int index { get; set; }

        }

        public static NodeIndice[] NodeIndices = new NodeIndice[2];

        public static DiskVert[] DiskVertList = new DiskVert[39];
    }
